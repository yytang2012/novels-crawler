...
class PopoSpider:
    ...
    def start_download(self, urls, username, password):
    ...
    def download_url(self, url):
        ...
        while True:
            time.sleep(0.5)
            sel = Selector(text=chrome_driver.page_source)
            chapters += sel.xpath('//div[@class="clist"]')
            try:
        ...
        for idx, chapter in enumerate(chapters):
            ...
            subtitle_url = chapter.xpath('a/@href').extract()[0]
            subtitle_url = urljoin(chrome_driver.current_url, subtitle_url)
            subtitle = chapter.xpath('div[@class="c2"]//text()').extract()[0]
...
if __name__ == '__main__':
    urls = [
        'https://www.popo.tw/books/626955',
    ]

    username, password = 'kissingerUS', 'xxx'
    spider = PopoSpider()

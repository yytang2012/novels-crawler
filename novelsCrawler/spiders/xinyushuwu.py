...
class XinyushuwuSpider(NovelSpider):
    """
    classdocs

    example: http://www.xinyushuwu.com/2/2689/
    """

    allowed_domains = ['www.xinyushuwu.com']
    ...
    def parse_episodes(self, response):
        sel = Selector(response)
        episodes = []
        subtitle_selectors = sel.xpath('//div[@class="ml_list"]/ul/li/a')
    ...
    def parse_content(self, response):
        sel = Selector(response)
        content = sel.xpath('//div[@class="novelcontent"]/p/text()').extract()

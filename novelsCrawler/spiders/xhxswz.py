...
class XhxswzSpider(NovelSpider):
    """
    classdocs
    ...
    allowed_domains = ['www.xhxswz.com']
    ...
    def parse_episodes(self, response):
        sel = Selector(response)
        episodes = []
        subtitle_selectors = sel.xpath('//div[@id="list-chapterAll"]/dd/a')
    ...
    def parse_content(self, response):
        sel = Selector(response)
        content = sel.xpath('//div[@class="readcontent"]/text()').extract()

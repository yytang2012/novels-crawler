...
class WenxuemmSpider(NovelSpider):
    """
    classdocs

    example: http://www.wenxuemm.com/book/2/2908/
    """

    dom = 'www.wenxuemm.com'
    ...
    def parse_episodes(self, response):
        sel = Selector(response)
        episodes = []
        subtitle_selectors = sel.xpath('//div[@class="novel_list"]/ul/li/a')
    ...
    def parse_content(self, response):
        sel = Selector(response)
        content = sel.xpath('//div[@id="clickeye_content"]/text()').extract()
